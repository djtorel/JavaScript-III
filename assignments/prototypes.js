...
*/
function CharacterStats({ healthPoints, ...constructors }) {
  GameObject.call(this, constructors);
...
*/
function Humanoid({ team, weapons, language, ...constructors }) {
  CharacterStats.call(this, constructors);
  this.team = team;
...
//   health points from objects which could result in destruction if health
//   gets to 0 or drops below 0;
// * Create two new objects, one a villain and one a hero and fight it out
//   with methods!
